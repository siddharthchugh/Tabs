...
public class List_Items_Adapter extends BaseAdapter {
    ...
    public List_Items_Adapter(Context con) {
        ...
        String[] lk = rs.getStringArray(R.array.gridData);
        int[] in = {R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher,
    ...
    class GridHolder {
        ...
        public GridHolder(View v) {
            ...
            cp = (TextView) v.findViewById(R.id.userSelection);
  //          cb = (CheckBox) v.findViewById(R.id.checkbox);
    ...
    public View getView(int i, View v, ViewGroup parent) {
        ...
        if (grid == null) {
            ...
            grid = infl.inflate(R.layout.grid_data, parent, false);
