...
public class Recycle_Adapt extends RecyclerView.Adapter<Recycle_Adapt.MyHolder>{
   ...
   private LayoutInflater inflater;
    ...
    List<Information> ls = Collections.emptyList();
   Context context;
    public Recycle_Adapt(Context con,List<Information> data){
   this.context= con;
   ...
   View vw = inflater.inflate(R.layout.information_convertview,parent,false);
    ...
    public void onBindViewHolder(MyHolder myHolder, int position) {
        ...
        Information current = ls.get(position);
