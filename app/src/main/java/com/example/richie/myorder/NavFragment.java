...
public class NavFragment extends Fragment implements Recycle_Adapt.ClickListener {
...
if(savedInstanceState!=null){
    ...
    public static List<Information> getData(){
        ...
        List<Information> ls = new ArrayList<>();
        String[] lk = {"ABout Us","Signout","Help"};
        int[] in = {R.mipmap.listcart,R.mipmap.listcart,R.mipmap.listcart };
...
return ls;
    ...
    public void onListItemClick(View v, int position) {
        ...
        switch (position){
            case 0:
                intent =  new Intent(getActivity(), AddItems.class);
